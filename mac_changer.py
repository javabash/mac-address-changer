...
def get_current_mac(interface):
    ...
    mac_search_result = re.search('\w\w:\w\w:\w\w:\w\w:\w\w:\w\w', str(ifconfig_result))
    # mac_search_result = re.search(b'\w\w:\w\w:\w\w:\w\w:\w\w:\w\w', ifconfig_result)
    if mac_search_result:
        return mac_search_result.group(0)
        # return mac_search_result.group(0).decode('utf-8')
    else:
